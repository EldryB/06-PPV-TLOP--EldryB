...
ENTITY_DEFS: Dict[str, Dict[str, Any]] = {
    ...
    "boss": {
        "texture": "boss",
        "animations": {
            "walk-down":  {"frames": [1,  2,  3,  4],  "interval": 0.15, "texture": "boss"},
            "walk-left":  {"frames": [5,  6,  7,  8],  "interval": 0.15, "texture": "boss"},
            "walk-right": {"frames": [9,  10, 11, 12], "interval": 0.15, "texture": "boss"},
            "walk-up":    {"frames": [13, 14, 15, 16], "interval": 0.15, "texture": "boss"},
            "idle-down":  {"frames": [17, 18, 19, 20], "interval": 0.20, "texture": "boss"},
            "idle-left":  {"frames": [21, 22, 23, 24], "interval": 0.20, "texture": "boss"},
            "idle-right": {"frames": [25, 26, 27, 28], "interval": 0.20, "texture": "boss"},
            "idle-up":    {"frames": [29, 30, 31, 32], "interval": 0.20, "texture": "boss"},
        },
    },
}
